...
KitchenQual_TA = st.selectbox("Kitchen Quality - Typical/Average (KitchenQual_TA)", [0,1], format_func=lambda x: "Yes" if x==1 else "No")
KitchenQual_Ex = st.selectbox("Kitchen Quality - Excellent (KitchenQual_Ex)", [0,1], format_func=lambda x: "Yes" if x==1 else "No")

KitchenQual_Ex = True if KitchenQual_Ex == "Yes" else False
KitchenQual_TA = True if KitchenQual_TA == "Yes" else False
